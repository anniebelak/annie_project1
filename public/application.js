...
// function startGame (){
//   user.turn = "x";
//   setMessageUser.turn+ "gets to start" )
// }
// function setMessa
...
// require('./example')
var scriptsEvents = __webpack_require__(9);
...
var createNewGame = function createNewGame(event) {
  ...
  api.create(data).then(ui.createNewGameSucess).catch(ui.createNewGameFailure);
  $('.square').text('');
  $('#win').text('');
  $('#gameOver').text('');
  $('#tie').text('');
...
var updateGame = function updateGame(event) {
  ...
  event.preventDefault();
  api.update(data).then(ui.updateGameSucess).catch(ui.updateGameFailure);
};
var getGame = function getGame(event) {
  event.preventDefault();
  api.index().then(ui.getGameSucess).catch(ui.getGameFailure);
};
...
var determineWinner = function determineWinner(gameBoard) {
  if (gameBoard[1] !== '' && gameBoard[0] === gameBoard[1] && gameBoard[1] === gameBoard[2] || gameBoard[3] !== '' && gameBoard[3] === gameBoard[4] && gameBoard[4] === gameBoard[5] || gameBoard[6] !== '' && gameBoard[6] === gameBoard[7] && gameBoard[7] === gameBoard[8] || gameBoard[1] !== '' && gameBoard[1] === gameBoard[4] && gameBoard[4] === gameBoard[7] || gameBoard[0] !== '' && gameBoard[0] === gameBoard[3] && gameBoard[3] === gameBoard[6] || gameBoard[2] !== '' && gameBoard[2] === gameBoard[5] && gameBoard[5] === gameBoard[8] || gameBoard[0] !== '' && gameBoard[0] === gameBoard[4] && gameBoard[4] === gameBoard[8] || gameBoard[6] !== '' && gameBoard[6] === gameBoard[4] && gameBoard[4] === gameBoard[2]) {
    $('#win').text('Player' + ' ' + player + ' ' + 'is the Winner!!!');
    gameOver = true;
  } else if (gameOver === false) {
    if (gameBoard.every(function (element) {
      return element !== '';
    })) {
      gameOver = true;
...
var createNewGameSucess = function createNewGameSucess(data) {
...
var updateGameSucess = function updateGameSucess(data) {
...
module.exports = {
  ...
  createNewGameSucess: createNewGameSucess,
  createNewGameFailure: createNewGameFailure,
  updateGameSucess: updateGameSucess,
